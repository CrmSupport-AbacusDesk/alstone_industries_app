            ...
            if(val == '' || val == null || val == undefined)
            {
                ...
                .subscribe((r)=>
                {
                    ...
                    if(r['status'] == "SUCCESS"){
                        ...
                        console.log( this.service.karigar_info, 'line number 66');
                    ...
                    .subscribe((resp)=>{
                        let updateAlert = this.alertCtrl.create({
                            ...
                            buttons: [
                                ...
                                {text: this.upd_now,
                                    handler: () => {
                                        window.open('https://play.google.com/store/apps/details?id=com.alstone.app&hl=en','_system','location=yes');
                                    } 
                                }
                            ]
                        });
