    ...
    getData() {
        ...
        this.service.post_rqst({ 'karigar_id': this.service.karigar_id }, 'app_karigar/karigarHome')
            .subscribe((r: any) => {
                ...
                if (this.karigar_detail.user_type != 5) {
    ...
    scanCoupon() {
        ...
        if (this.karigar_detail.status == 'Suspect') {
            let alert = this.alertCtrl.create({
                ...
                subTitle: "Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see your offers when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                ...
                subTitle: "Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see your offers when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see your offers when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
                                ...
                                this.service.post_rqst({ 'karigar_id': this.service.karigar_id, 'qr_code': this.qr_code,'coupon_scan_lat':this.lat,'coupon_scan_long':this.long }, 'app_karigar/karigarCoupon')
                                    .subscribe((r: any) => {
                                        ...
                                        if (r['status'] == 'INVALID') {
                                            ...
                                            this.translate.get("Point not exist on this coupon")
                                                .subscribe(resp => {
                                                    this.showAlert(resp);
                                                })
                                            return;
    ...
    goOnPlumberList() {
        ...
        if (this.karigar_detail.status == 'Suspect') {
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close',
                subTitle: "Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only plumber add when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only plumber add when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only plumber add when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
    ...
    goOnPointeListPage() {
        ...
        if (this.karigar_detail.status == 'Suspect') {
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close',
                subTitle: "Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see your points history when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see your points history when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see your points history when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
    ...
    goOnContractorPage() {
        ...
        if (this.karigar_detail.status == 'Suspect') {
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close',
                subTitle: "Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only earn your points when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only earn your points when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only earn your points when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
    ...
    gotoHistory() {
        ...
        if (this.karigar_detail.status == 'Suspect') {
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close',
                subTitle: "Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see your points redeem history when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see your points redeem history when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see your points redeem history when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
    ...
    goRedeemType() {
        ...
        if (this.karigar_detail.status == 'Suspect') {
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close',
                subTitle: "Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only redeem your points when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only redeem your points when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
            ...
            let alert = this.alertCtrl.create({
                title: 'Sorry!',
                cssClass: 'action-close status-alert',
                subTitle: "Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only redeem your points when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:011-42307700>011-42307700</a> or chat with us.",
                buttons: [
                    {
                        // text: 'Chat With Us',
                        //   role: 'cancel',
        ...
        else if (this.karigar_detail.user_type != 5 && this.karigar_detail.status == 'Verified') {
